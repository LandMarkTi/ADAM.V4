...
export class SolicitacaoComponent implements OnInit {
    ...
    abreEdicaoItem(idSolicitacaoItem: number ) {
        if (idSolicitacaoItem !== undefined && idSolicitacaoItem !== null) {
            this.tituloJanelaEdicao = 'Alteração';
            this.solicitacaoService.obterItem(idSolicitacaoItem).pipe(takeUntil(this.destroy$)).subscribe((data: SolicitacaoItem) => {
                this.isLoadPanelVisible = false;
                this.solicitacaoItem = data;
                this.configuraTelaItem();
            },
            error => {
                this.errorHandler(error);
            });
        } else {
            this.tituloJanelaEdicao = 'Novo';
            this.solicitacaoItem = new SolicitacaoItem;
        }
    }

    configuraTelaItem(): void {
    ...
    editarItem(e, data) {
        const idItem: number = data.row.data.idSolicitacaoItem;
        // this.router.navigate(['item'], { queryParams: { idItem: idItem, idRequest : this.idRequest } } );
    }
