...
export class ListaUsuariosComponent implements OnInit {
    ...
    constructor(private usuarioService: UsuarioService, private router: Router, private autenticacaoService: AutenticacaoService) {
    ...
    carregaLista(): void {
        ...
        this.usuarioService.listUsuario().pipe(takeUntil(this.destroy$)).subscribe((data: any[]) => {
            this.isLoadPanelVisible = false;
            this.usuarios = data;
        },
        error => {
    ...
    deletar(e, data) {
        this.idExclusao  = data.row.data.idUsuario;
        this.isPopupConfimarVisible = true;
    }

    editar(e, data) {
        const idUsuario: number = data.row.data.idUsuario;
        this.router.navigate(['usuario'], { queryParams: { 'idUsuario': idUsuario } } );
    }

    ativar(e, data): void {
        this.idAtivacao  = data.row.data.idUsuario;
    ...
    confirmacaoOK(): void {
        ...
        this.isLoadPanelVisible = true;
        this.usuarioService.definirStatusAtivo(this.idExclusao, false).pipe(takeUntil(this.destroy$)).subscribe((res: any[]) => {
            this.isLoadPanelVisible = false;
            this.carregaLista();
    ...
    confirmacaoAtivarOK(): void {
        ...
        this.isLoadPanelVisible = true;
        this.usuarioService.definirStatusAtivo(this.idAtivacao, true).pipe(takeUntil(this.destroy$)).subscribe((res: any[]) => {
            this.isLoadPanelVisible = false;
            this.carregaLista();
